...
from util import boolean_string
from xadam import XAdam, Fp16Optimizer, ExpLossScaler, get_world_size
...
def create_xadam(model, num_train_steps):
    args = get_args().parse_args()
    return create_xoptimizer(model, args, num_train_steps)